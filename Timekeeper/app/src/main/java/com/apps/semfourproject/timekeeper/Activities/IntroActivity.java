...
public class IntroActivity extends AppIntro2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderPage1.setDescription("Timekeeper helps you channel your focus on the work and boost your productivity.");
        sliderPage1.setImageDrawable(R.drawable.icon);
        sliderPage1.setBgColor(Color.parseColor("#311B92"));
        ...
        sliderPage2.setBgColor(Color.parseColor("#311B92"));
        ...
        sliderPage3.setBgColor(Color.parseColor("#311B92"));
