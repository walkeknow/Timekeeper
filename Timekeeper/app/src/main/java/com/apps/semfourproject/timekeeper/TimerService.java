...
import com.apps.semfourproject.timekeeper.Events.StartForegroundEvent;
...
public class TimerService extends Service{
    ...
    public static final String ACTION_COUNTDOWN_FINISHED =
            "com.apps.semfourproject.timekeeper.ACTION_COUNTDOWN_FINISHED";
    public final static String ACTION_TIMERSERVICE_ALARM =
            "com.apps.semfourproject.timekeeper.ACTION_TIMERSERVICE_ALARM";
    public static final String ACTION_WORK_MODE_STOPPED =
            "com.apps.semfourproject.timekeeper.ACTION_WORK_MODE_STOPPED";
